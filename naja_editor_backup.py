...
class NajaScriptEditor:
    ...
    def configure_style(self):
        ...
        self.colors = {
            ...
            'fg_keyword': '#cc7832',          # Palavras-chave
            'fg_builtin': '#a9b7c6',          # Funções integradas
            'fg_string': '#6a8759',           # Strings
            'fg_number': '#6897bb',           # Números
            'fg_comment': '#808080',          # Comentários
            'fg_module': '#ffc66d',           # Módulos
            'fg_literal': '#9876aa',          # Literais (true, false)
            'selection_bg': '#214283',        # Fundo da seleção
        ...
        style.configure('TButton', padding=5, background=self.colors['button_bg'], foreground=self.colors['button_fg'])
        style.map('TButton', 
                background=[('active', self.colors['button_bg'])],
                foreground=[('active', self.colors['fg_text'])])
        ...
        style.configure('TPanedwindow', background=self.colors['bg_panel'])
